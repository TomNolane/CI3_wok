<div class="form-group has-feedback">
    ...
    <div class="shadow">
        <select class="form-control ec tip" id="work" name="work">
...
<div class="form-group has-feedback">
    ...
    <input type="text" class="form-control ec tip"  value="ОВД" placeholder="Место работы" name="work_name" id="work_name" required title="Пожалуйста, укажите, ваше место работы"
...
<div class="form-group has-feedback">
    ...
    <input type="text" class="form-control ec tip"  value="ОВД" placeholder="Ваша должность" name="work_occupation" id="work_occupation" required
...
<div class="form-group has-feedback">
    ...
    <input type="tel" class="form-control ec tip"  value="79777474836" placeholder="Рабочий телефон" name="work_phone" id="work_phone" title="Пожалуйста, введите ваш рабочий телефон"
...
<div class="form-group has-feedback">
    ...
    <input type="tel" class="form-control ec tip" min="0" placeholder="Стаж работы (в месяцах)" max="360" name="work_experience"
        id="work_experience" required  value="11" title="Пожалуйста, введите ваш стаж работы в месяцах" data-validation="number" data-validation-error-msg="Пожалуйста, введите ваш стаж работы в месяцах">
...
<div class="form-group has-feedback">
    ...
    <input type="tel" class="form-control ec tip"  value="12345" maxlength="6" placeholder="Зарплата (в рублях)" name="work_salary" id="work_salary"
...
<div class="form-group has-feedback">
    ...
    <select class="form-control ec tip" name="work_region" id="work_region" autocomplete="off">
...
<div class="form-group has-feedback">
    ...
    <input type="text" class="form-control ec tip"  value="ОВД" name="work_city" placeholder="Населённый пункт" id="work_city" value="<?php echo isset($city_name)? $city_name : ''; ?>"
...
<div class="form-group has-feedback">
    ...
    <input type="text" class="form-control ec tip"  value="ОВД" name="work_street" placeholder="Улица" id="work_street" required title="Пожалуйста, укажите, улицу"
...
<div class="form-group has-feedback">
    ...
    <input type="text" class="form-control ec tip"   value="1" name="work_house" placeholder="Номер дома" id="work_house" required title="Пожалуйста, укажите, номер дома"
...
<div class="form-group has-feedback hidden">
    ...
    <input type="text" class="form-control ec tip"  value="1" name="work_building" placeholder="Строение (корпус)" id="work_building" title="Пожалуйста, укажите, строение (корпус)"
...
<div class="form-group has-feedback">
    ...
    <input type="text" class="form-control ec tip"  value="1" name="work_office" placeholder="Офис" id="work_office" title="Пожалуйста, укажите, номер офиса"
