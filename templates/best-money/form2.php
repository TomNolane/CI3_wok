...
<div class="form-group has-feedback">
    ...
    <input type="text" class="form-control ec tip" value="4510 123456" name="passportdate" id="passportdate" placeholder="Дата выдачи паспорта" title="Пожалуйста, выберете дату выдачи паспорта" data-validation="custom" data-validation-regexp="^[0-9]{2}\/[0-9]{2}\/[0-9]{4}$" data-validation-error-msg="Пожалуйста, выберите дату выдачи паспорта" required>
    <span id="passportdatestatus" class="glyphicon form-control-feedback" aria-hidden="true"></span>
</div>
<input type="hidden" class="form-control ec" id="passport-s" name="passport_s" value="4510" placeholder="0000" title="Серия паспорта" data-validation="number" data-validation-allowing="range[1;9999]" data-validation-error-msg="Пожалуйста, введите серию паспорта" required>
<input type="hidden" class="form-control ec" id="passport-n" name="passport_n" value="123456" placeholder="000000" title="Номер паспорта"  data-validation="number" data-validation-allowing="range[1;999999]" data-validation-error-msg="Пожалуйста, введите номер паспорта" required>
...
<div class="form-group has-feedback">
    ...
    <input type="tel" class="form-control ec tip" value="770-098" name="passport_code" id="passport_code" placeholder="Код подразделения" title="Пожалуйста, укажите код подразделения" data-validation="custom" data-validation-regexp="^([0-9]{3}\-[0-9]{3})$" data-validation-error-msg="Пожалуйста, введите код подразделения" required>
...
<div class="form-group has-feedback">
    ...
    <input type="text" class="form-control ec tip" value="ОВД" name="passport_who" id="passport_who" placeholder="Кем выдан паспорт" title="Пожалуйста, укажите кем выдан паспорт" data-validation="custom" data-validation-regexp="^[А-Яа-яЁё\-\.\№\(\)\s\d]+$" data-validation-error-msg="Пожалуйста, укажите, кем выдан паспорт" required>
...
<div class="form-group has-feedback">
    ...
    <input type="text" class="form-control ec tip" value="ОВД" name="birthplace" id="birthplace" placeholder="Место рождения" data-validation="custom" data-validation-regexp="^[А-Яа-яЁё\-\.\(\)\s]+$" data-validation-error-msg="Пожалуйста, укажите место рождения" required>
...
<div class="form-group has-feedback">
    ...
    <input type="text" class="form-control ec tip"  value="ОВД" name="street" id="street" placeholder="Улица" title="Улица" required title="Пожалуйста, укажите, улицу"  data-validation="custom" data-validation-regexp="^[А-Яа-яЁё\d\s\-\,\#\.\+\(\)]+$" data-validation-error-msg="Пожалуйста, укажите, улицу">
...
<div class="form-group has-feedback">
    ...
    <input type="text" class="form-control ec tip"  value="1" name="building"  placeholder="Номер дома" id="building" title="Дом" required title="Пожалуйста, укажите, номер дома" pattern="^[А-Яа-яЁё0-9\s]+$" data-validation="custom" data-validation-regexp="^[А-Яа-яЁё0-9\-\.\(\)\s]+$" data-validation-error-msg="Пожалуйста, укажите, номер дома">
...
<div class="form-group has-feedback" style="display:none;">
    ...
    <input type="text" class="form-control ec tip"  value="2" name="housing" id="housing" placeholder="Строение (корпус)" title="Пожалуйста, укажите, строение (корпус)" pattern="^[А-Яа-яЁё0-9\s]+$" data-validation="custom" data-validation-regexp="^[А-Яа-яЁё0-9\-\.\(\)\s]+$" data-validation-error-msg="Пожалуйста, укажите, строение (корпус)" data-validation-optional="true">
...
<div class="form-group has-feedback">
    ...
    <input type="text" class="form-control ec tip"  value="2" name="flat" id="flat" placeholder="Квартира" title="Пожалуйста, укажите, номер квартиры" pattern="^[А-Яа-яЁё0-9\s]+$" data-validation="custom" data-validation-regexp="^[А-Яа-яЁё0-9\-\.\(\)\s]+$" data-validation-error-msg="Пожалуйста, укажите, номер квартиры" data-validation-optional="true">
