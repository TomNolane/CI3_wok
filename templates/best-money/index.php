        ...
        <div class="row">
            <div class="col-xs-12">
                ...
                <p>
                    ...
                    суммы.
                    <b>best-money</b> предлагает идеальный выход из ситуации - мгновенный онлайн-займ. Для того чтобы получить финансовую
...
<section class="conditions hidden-xs">
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-12">
                <p>Сервис
                    <b>best-money</b> экономит ваше время и энергию. Заявку можно подать из любой точки страны. Главное условие
                    - наличие интернета.
                    <br> С нашей помощью вы легко улучшите кредитную историю, если до этого возникали какие-то проблемы.
                    <br>
                    <b>best-money</b> - современное решение финансовых затруднений.</p>
            </div>
        </div>
    </div>
</section>
<section class="conditions hidden-xs">
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12">
                <p>
                    <b>best-money</b> - это не отдельная микрофинансовая организация, а посредник между заемщиком и кредитором.
    ...
    <div class="container">
        <div class="row">
            <div class="col-xs-6">
                ...
                <div class="col-xs-12">
                    <p>Вы можете получить деньги даже с плохой кредитной историей. Среди клиентов сервиса best-money есть и студенты,
