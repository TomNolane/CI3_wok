...
<footer class="ex-main-footer ex-sticky-footer">
        ...
        <div class="row">
            <div class="col-lg-2">
                <div class="ex-foot-logo">
                    <a href=""><img src="/templates/zaimomix_tk/assets/img/logo-footer.png" alt="logo-footer.png"></a>
                </div>
            </div>
            <div class="col-lg-10">
                <p>Сервис по подбору выгодных онлайн займов<br>
                Займы предоставляются на сумму от 1 000 до 100 000 рублей включительно на срок от  61 до 365 дней. Максимальная процентная ставка по займу составляет 0,98% в день, а минимальная 0,08%.
                Пример расчета общей стоимости займа: заём 20 000 руб. срок пользования 10 недель под 0,08% в день; проценты за весь период составят 11 200 руб. Итого к выплате 31 200 рублей.<br>
                Первый заём до 10 000 рублей выдается по ставке 0% в случае своевременного погашения.</p>
            </div>
        </div>
    </div>
</footer> 
    ...
    echo '</script>';
    echo '<script>';
    require 'templates/zaimomix_tk/assets/js/bootstrap.min.js';
    echo '</script>';
    echo '<script>';
    ...
    echo '</script>';
    echo '<script>';
    require 'templates/zaimomix_tk/assets/js/jquery.pickmeup.twitter-bootstrap.js';
    echo '</script>';
    echo '<script>';
    require 'templates/zaimomix_tk/assets/js/pickmeup.min.js';
    echo '</script>';
    echo '<script>';
    require 'templates/zaimomix_tk/assets/js/jquery.form-validator.js';
    echo '</script>';
    echo '<script>';
    require 'templates/zaimomix_tk/assets/js/jquery.suggestions.min.js';
    echo '</script>';
    echo '<script>';
    require 'templates/zaimomix_tk/assets/js/coockie.js';
    echo '</script>';
    require 'templates/common/detect.min.php';
    echo '<script>';
    require 'templates/zaimomix_tk/assets/js/custom.js';
    echo '</script>';
    echo '<script>';
    require 'templates/zaimomix_tk/assets/js/settings_form.js';
    echo '</script>';
    ?>
...
{ 
    ...
    echo '</script>';
    echo '<script>';
    require 'templates/zaimomix_tk/assets/js/loanCalculator.js';
    echo '</script>';
?>
...
<?php require 'templates/zaimomix_tk/assets/js/owl.carousel.min.js';?>
