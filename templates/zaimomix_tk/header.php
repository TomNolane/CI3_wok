...
<head>
	...
	<meta name="copyright" lang="ru" content="zaimomix.tk" />
	...
	<meta property="og:image" content="https://zaimomix.tk/templates/zaimomix_tk/assets/img/bg.png"/>
	<meta property="og:type" content="website"/>
	<meta property="og:url" content="https://zaimomix.tk/" />
	<meta name="twitter:card" content="https://zaimomix.tk/templates/zaimomix_tk/assets/img/bg.png"/>
	...
	<meta name="twitter:image:src" content="https://zaimomix.tk/templates/zaimomix_tk/assets/img/bg.png"/>
	<meta name="twitter:url" content="https://zaimomix.tk/"/>
	<meta name="twitter:domain" content="zaimomix.tk"/>

    <!-- Favicons -->
    <link rel="shortcut icon" href="/templates/zaimomix_tk/favicon/favicon-16x16.png" type="image/png">
    <link rel="apple-touch-icon" sizes="57x57" href="/templates/zaimomix_tk/favicon/apple-icon-57x57.png">
    <link rel="apple-touch-icon" sizes="60x60" href="/templates/zaimomix_tk/favicon/apple-icon-60x60.png">
    <link rel="apple-touch-icon" sizes="72x72" href="/templates/zaimomix_tk/favicon/apple-icon-72x72.png">
    <link rel="apple-touch-icon" sizes="76x76" href="/templates/zaimomix_tk/favicon/apple-icon-76x76.png">
    <link rel="apple-touch-icon" sizes="114x114" href="/templates/zaimomix_tk/favicon/apple-icon-114x114.png">
    <link rel="apple-touch-icon" sizes="120x120" href="/templates/zaimomix_tk/favicon/apple-icon-120x120.png">
    <link rel="apple-touch-icon" sizes="144x144" href="/templates/zaimomix_tk/favicon/apple-icon-144x144.png">
    <link rel="apple-touch-icon" sizes="152x152" href="/templates/zaimomix_tk/favicon/apple-icon-152x152.png">
    <link rel="apple-touch-icon" sizes="180x180" href="/templates/zaimomix_tk/favicon/apple-icon-180x180.png">
    <link rel="icon" type="image/png" sizes="192x192"  href="/templates/zaimomix_tk/favicon/android-icon-192x192.png">
    <link rel="icon" type="image/png" sizes="32x32" href="/templates/zaimomix_tk/favicon/favicon-32x32.png">
    <link rel="icon" type="image/png" sizes="96x96" href="/templates/zaimomix_tk/favicon/favicon-96x96.png">
    <link rel="icon" type="image/png" sizes="16x16" href="/templates/zaimomix_tk/favicon/favicon-16x16.png">
    <link rel="manifest" href="/templates/zaimomix_tk/favicon/manifest.json">
    <meta name="msapplication-TileColor" content="#ffffff">
    <meta name="msapplication-TileImage" content="/templates/zaimomix_tk/favicon/ms-icon-144x144.png">
    <meta name="theme-color" content="#ffffff">

    <!-- CSS -->
     <?php 
     echo '<style>';
     require 'templates/zaimomix_tk/assets/css/style.css';
     echo '</style>';
     echo '<style>';
     require 'templates/zaimomix_tk/assets/css/style_custom.css';
     echo '</style>';
     echo '<style>';
     require 'templates/zaimomix_tk/assets/css/font-awesome.min.css';
     echo '</style>';
     echo '<style>';
     require 'templates/zaimomix_tk/assets/css/suggestions.min.css';
     echo '</style>'; 
     echo '<style>'; 
     echo '.tip-twitter {
         opacity:0.8;
     ...
     .tip-twitter .tip-arrow-top {
         ...
         width:9px;
         height:5px;
         background:url(/templates/zaimomix_tk/assets/img/tip-twitter_arrows.gif) no-repeat;
     }
     .tip-twitter .tip-arrow-right {
         ...
         width:5px;
         height:9px;
         background:url(/templates/zaimomix_tk/assets/img/tip-twitter_arrows.gif) no-repeat -9px 0;
     }
     .tip-twitter .tip-arrow-bottom {
         ...
         width:9px;
         height:5px;
         background:url(/templates/zaimomix_tk/assets/img/tip-twitter_arrows.gif) no-repeat -18px 0;
     }
     .tip-twitter .tip-arrow-left {
         ...
         width:5px;
         height:9px;
         background:url(/templates/zaimomix_tk/assets/img/tip-twitter_arrows.gif) no-repeat -27px 0;
     }';
     echo '</style>';
     ...
     {
         echo '<style>';
         require "templates/zaimomix_tk/assets/css/style_lk.css";
         echo '</style>';
     }
     ?>
     <!--[if lte IE 9]>
