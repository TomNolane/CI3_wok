...
{
	echo '<!-- Cashnow1.tk --> <ins class="adsbygoogle text-center" style="display:block" data-ad-client="ca-pub-2169296404508755" data-ad-slot="6486610168" data-ad-format="auto"></ins> <script> (adsbygoogle = window.adsbygoogle || []).push({}); </script>';
}
?>
...
?>
            ...
            <div class="row">
                <div class="col-lg-2">
                    <div class="ex-foot-logo">
                        <a href="/">
                            <img src="/templates/cashnow1_tk/assets/img/footer-logo.png" alt="footer-logo.png">
                        </a>
                    </div>
                </div>
                <div class="col-lg-10">
                    <p>
                        ...
                        Сервис по подбору выгодных онлайн займов и кредитов находящийся по адресу:
    ...
    echo '<script>';
    require 'templates/cashnow1_tk/assets/js/jquery.min.js';
    echo '</script>'; 
    echo '<script>';
    require 'templates/cashnow1_tk/assets/js/bootstrap.min.js';
    echo '</script>';
    echo '<script>';
    ...
    echo '</script>'; 
    echo '<script>';
    require 'templates/cashnow1_tk/assets/js/jquery.form-validator.js';
    echo '</script>';
    echo '<script>';
    require 'templates/cashnow1_tk/assets/js/jquery.suggestions.min.js';
    echo '</script>'; 
    echo '<script>';
    require 'templates/cashnow1_tk/assets/js/coockie.js';
    echo '</script>';
    echo '<script>';
    require 'templates/cashnow1_tk/assets/js/modal.js';
    echo '</script>';
    echo '<script>';
    require 'templates/cashnow1_tk/assets/js/custom.js';
    echo '</script>';
    echo '<script>';
    require 'templates/cashnow1_tk/assets/js/settings_main.js';
    echo '</script>';
    echo '<script>';
    require 'templates/cashnow1_tk/assets/js/settings_form.js';
    echo '</script>';
    echo '<!-- backtotop -->
    <script>
    ...
    echo '<script>';
    require 'templates/cashnow1_tk/assets/js/get_parameter.js';
    echo '</script>';
...
<![endif]-->
    ...
    <script>
        ...
        <?php require 'templates/cashnow1_tk/assets/js/loanCalculator.js';?>
