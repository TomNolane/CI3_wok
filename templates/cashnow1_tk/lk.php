...
// <a href="'.$item['link'].'" onclick="markTarget(\'pixel_result\', \''.$item['title'].'\', \''.$pixel.'\')" target="_blank"><img  src="'.$item['img'].'.png" class="'.$item['img'].'" alt="'.$item['title'].'"></a>
...
<table>
    ...
    <tr>
        <td data-label="Кредитная организация"> 
            <div><a href="'.$item['link'].'" onclick="markTarget(\'pixel_result\', \''.$item['header'].'\', \''.$pixel.'\')" target="_blank"><img  src="'.$item['img'].'" class="img-fluid2 '.$item['img'].'" alt="'.$item['header'].'"></a></div>
        </td>
        <td data-label="">
            <div><b class="text-left" style="line-height: 20px;">'.$item["text"].'</div>
        </td>  
        <td data-label="">
            <div>
                <a style="color: #000000" href="'.$item['link'].'" onclick="markTarget(\'pixel_result\', \''.$item['header'].'\', \''.$pixel.'\')"   target="_blank"><button class="ex-main-btn ">'.$item['btn'].'</button></a>
            </div>
        </td>
    </tr> 
    </tbody>
