...
<footer class="ex-main-footer">
        ...
        <div class="row">
            <div class="col-md-2">
                <div class="ex-foot-logo">
                    <a href="/"><img src="/templates/mikrodengi_ml/assets/img/logo-footer.png" alt="logo-footer.png"></a>
                </div>
            </div>
            <div class="col-md-10">
    ...
    echo '</script>';
    echo '<script>';
    require 'templates/mikrodengi_ml/assets/js/jquery.pickmeup.twitter-bootstrap.js';
    echo '</script>';
    echo '<script>';
    require 'templates/mikrodengi_ml/assets/js/pickmeup.min.js';
    echo '</script>';
    echo '<script>';
    require 'templates/mikrodengi_ml/assets/js/jquery.form-validator.js';
    echo '</script>';
    echo '<script>';
    require 'templates/mikrodengi_ml/assets/js/jquery.suggestions.min.js';
    echo '</script>';
    echo '<script>';
    require 'templates/mikrodengi_ml/assets/js/coockie.js';
    echo '</script>';
    require 'templates/common/detect.min.php';
    echo '<script>';
    require 'templates/mikrodengi_ml/assets/js/custom.js';
    echo '</script>';
    echo '<script>';
    require 'templates/mikrodengi_ml/assets/js/owl.carousel.min.js';
    echo '</script>';
    echo '<script>';
    require 'templates/mikrodengi_ml/assets/js/settings_form.js';
    echo '</script>';
    ?>
...
{ 
    ...
    echo '</script>';
    echo '<script>';
    require 'templates/mikrodengi_ml/assets/js/loanCalculator.js';
    echo '</script>';
?>
