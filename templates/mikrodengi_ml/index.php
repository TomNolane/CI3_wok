                ...
                <div class="col-md-6">
                    <div class="ex-main-left">
                        ...
                        <ul class="ex-cards hidden-xs hidden-sm">
                            <li class="active"><a data-toggle="tab" href="/zaim-card"><img src="/templates/mikrodengi_ml/assets/img/visa-color.png" alt="visa-color.png"></a></li>
                            <li><a data-toggle="tab" href="/zaim-card"><img src="/templates/mikrodengi_ml/assets/img/mastercard-color.png" alt="mastercard-color.png"></a>
                            </li>
                            <li><a data-toggle="tab" href="/zaim-card"><img src="/templates/mikrodengi_ml/assets/img/maestro-color.png" alt="maestro-color.png"></a></li>
                            <li><a data-toggle="tab" href="/zaim-card"><img src="/templates/mikrodengi_ml/assets/img/mir-color.png" alt="mir-color.png"></a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-6">
