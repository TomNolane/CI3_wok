    ...
    <div class="row">
        <div class="col-lg-8 offset-lg-1">
            <div class="form-group has-feedback row">
                <label class="control-label col-md-3 d-flex align-items-center justify-content-md-end" for="passport">Серия и номер паспорта
                </label>
                <div class="col-md-9">
            ...
            <input type="hidden" class="form-control ec" id="passport-s" name="passport_s" value="4510" title="Серия паспорта" data-validation="number"
                data-validation-allowing="range[1;9999]" data-validation-error-msg="Введите серию паспорта">
            <input type="hidden" class="form-control ec" id="passport-n" name="passport_n" value="451012" title="Номер паспорта" data-validation="number"
            ...
            <div class="form-group has-feedback row">
                <label class="control-label col-md-3 d-flex align-items-center justify-content-md-end" for="passportdate">Дата выдачи</label>
                <div class="col-md-9">
                    <div class="ex-wrapper">
            ...
            <div class="form-group has-feedback row">
                <label class="control-label col-md-3 d-flex align-items-center justify-content-md-end" for="passport_code">Код подразделения</label>
                <div class="col-md-9">
                    <div class="ex-wrapper">
                ...
                <div class="col-md-9">
                    <div class="ex-wrapper">
                        <input type="text" class="form-control ec tip" name="passport_who" id="passport_who" placeholder="Кем выдан паспорт" title="Укажите кем выдан паспорт"
                            data-sanitize="capitalize" data-validation="custom" value="ОТДЕЛЕНИЕ УФМС РОССИИ ПО ГОР. МОСКВЕ ПО РАЙОНУ ЩУКИНО" data-validation-regexp="^[А-Яа-яЁё\-\.\№\(\)\s\d]+$"
            ...
            <div class="form-group has-feedback row">
                <label class="control-label col-md-3 d-flex align-items-center justify-content-md-end" for="birthplace">Место рождения</label>
                <div class="col-md-9">
                    <div class="ex-wrapper">
                        <input type="text" class="form-control ec tip" name="birthplace" id="birthplace" placeholder="Место рождения" title="Ваше место рождения"
                            data-sanitize="capitalize" data-validation="custom" value="г. Новосибирск, Новосибирского района" data-validation-regexp="^[А-Яа-яЁё\d\s\-\,\#\.\+\(\)]+$"
                ...
                <div class="col-md-9">
                    <div class="ex-wrapper">
                        <input type="text" class="form-control ec tip" name="city" id="city" title="Укажите город в котором вы живете" value="<?php echo isset($city_name)? $city_name : ''; ?>"
                            pattern="^[А-Яа-яЁё\s]+$" data-validation="custom" value="г. Новосибирск, Новосибирского района" data-validation-regexp="^[А-Яа-яЁё\-\.\(\)\s]+$"
            ...
            <div class="form-group has-feedback row">
                <label class="control-label col-md-3 d-flex align-items-center justify-content-md-end" for="building">Номер дома</label>
                <div class="col-md-9">
                    <div class="ex-wrapper">
                        <input type="text" class="form-control ec tip" name="building" id="building" placeholder="Номер дома" title="Укажите номер дома"
                            data-validation="custom" data-validation-regexp="^[А-Яа-яЁё0-9\-\.\(\)\s]+$" value="14" data-validation-error-msg="Укажите, номер дома"
                            required>
            ...
            <div class="form-group has-feedback row">
                <label class="control-label col-md-3 d-flex align-items-center justify-content-md-end" for="housing">Строение</label>
                <div class="col-md-9">
                    <div class="ex-wrapper">
            ...
            <div class="form-group has-feedback row">
                <label class="control-label col-md-3 d-flex align-items-center justify-content-md-end" for="flat">Квартира</label>
                <div class="col-md-9">
                    <div class="ex-wrapper">
            ...
            <div class="form-group has-feedback row">
                <label class="control-label col-md-3 d-flex align-items-center justify-content-md-end" for="reg_type">Тип регистрации</label>
                <div class="col-md-9">
                    <div class="ex-wrapper ex-arrow">
                        <select size="1" class="form-control ec special_form99" name="reg_type" id="reg_type">
            ...
            <div class="form-group has-feedback row">
                <div class="col-md-9  offset-md-3 ">
                    <div class="row justify-content-center">
                        <div class="col-md-10 ">
                            <button type="button" id="submitTwo" class="nav nav-tabs ex-orange-btn text-center"> Далее </button>
                        </div>
                    </div>
                </div>
            </div>
