            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <div id="toolbar" class="btn-group">
                        ...
                        <div class="btn-group">
                          ...
                          <ul class="dropdown-menu">
                            <li><a href="https://dengimo.ru/dashboard_new/market/<?=$date1?>/<?=$date2?>/bzaim5.ru/<?=$referrer?>">Bzaim5</a></li>
                            <li><a href="https://dengimo.ru/dashboard_new/market/<?=$date1?>/<?=$date2?>/dengoman.ru/<?=$referrer?>">Dengoman</a></li>
                            <li><a href="https://dengimo.ru/dashboard_new/market/<?=$date1?>/<?=$date2?>/dengimo.ru/<?=$referrer?>">Dengimo</a></li>
                            <li role="separator" class="divider"></li>
                            <li><a href="https://dengimo.ru/dashboard_new/market/<?=$date1?>/<?=$date2?>/all/<?=$referrer?>">Все сайты</a></li>
                          </ul>
                        </div>                        
                        <div class="btn-group">
                          <button type="button" class="btn btn-sm btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                          ...
                          <ul class="dropdown-menu">
                            <li><a href="https://dengimo.ru/dashboard_new/market/<?=$date1?>/<?=$date2?>/<?=$site?>/direct">Direct</a></li>
                            <li><a href="https://dengimo.ru/dashboard_new/market/<?=$date1?>/<?=$date2?>/<?=$site?>/mytarget">Mytarget</a></li>
                            <li><a href="https://dengimo.ru/dashboard_new/market/<?=$date1?>/<?=$date2?>/<?=$site?>/vk">VK</a></li>
                            <li><a href="https://dengimo.ru/dashboard_new/market/<?=$date1?>/<?=$date2?>/<?=$site?>/google">Google</a></li>
                            <li><a href="https://dengimo.ru/dashboard_new/market/<?=$date1?>/<?=$date2?>/<?=$site?>/sendpulse">SendPulse</a></li>
                            <li><a href="https://dengimo.ru/dashboard_new/market/<?=$date1?>/<?=$date2?>/<?=$site?>/email">Email</a></li>    
                            <li role="separator" class="divider"></li>
                            <li><a href="https://dengimo.ru/dashboard_new/market/<?=$date1?>/<?=$date2?>/<?=$site?>/all">Все источники</a></li>
                          </ul>
                        </div>                        
			        ...
			        <th data-field="date" data-sortable="true">Дата</th> 
                                ...
                                <th data-field="firano">Cityads (<span class="text-success">Принято</span> | <span class="text-danger">Отказ</span>)</th>
                                <th data-field="admitad">Admitad (Быстроденьги) (<span class="text-success">Принято</span> | <span class="text-danger">Отказ</span>)</th>
                            </tr>
			</thead>
                        <tbody>
                            <?php foreach($data as $item) { ?>
                                ...
                                echo '<tr class="">'
                                    ...
                                    . '<td><span class="text-success">'.$item['l']['admitad_bystradengi']['processing'].'</span><span class="text-danger"> | '. 0 .'</span></td>'
                                . '</tr>'; ?>
                            <?php } ?>                           
                        </tbody>
                    </table>
