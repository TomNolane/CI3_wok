	...
	<script>
        ...
        $('#daterange').on('apply.daterangepicker', function(ev, picker) {
            location.href = 'http://edenga.ru/dashboard_new/market/'+picker.startDate.format('YYYY-MM-DD')+'/'+picker.endDate.format('YYYY-MM-DD')+'/<?=$site?>/<?=$referrer?>';
        });        
        </script>
        <script>
